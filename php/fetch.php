...
// START
$dbh = new PDO('mysql:host=localhost:3306;dbname=cinema;', 'root', '');
...
{
    switch ($_POST['filter']) {
        case 'film':return 'f.titre';
            break;
        case 'genre':return 'g.nom';
            break;
        case 'distrib':return 'd.nom';
            break;
        case 'search-m-filter-id-null':return 'members';
            break;
    }
}
