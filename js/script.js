...
function moviePage(data) {
  ...
  let vid_url_request = `https://api.themoviedb.org/3/movie/${themoviedb_id}/videos?api_key=09b47a32830cc8c808b2c69be226f81b`;
...
function publishReview(id_film) {
  ...
  let id = id_film + '|' + reviewContent + '|' + localStorage.User;
